                ...
                <div class="col-6 "> 
                    <div class="card mx-auto my-3">
                        <div class="card-body">
                          ...
                          <a class="btn btn-success" href={{route('articles.index')}}>Direction blog</a>
                        </div>
                      </div>
                </div>
                <div class="col-6 "> 
                    <div class="card mx-auto my-3">
                        <div class="card-body">
                          ...
                          <a class="btn btn-success" href={{route('cards.index')}}>Direction portfolio</a>
                        </div>
                      </div>
                </div>
                <div class="col-6 "> 
                    <div class="card mx-auto my-3">
                        <div class="card-body">
                          ...
                          <a class="btn btn-success" href="">Direction contact</a>
                        </div>
                      </div>
                </div>
            </div>
